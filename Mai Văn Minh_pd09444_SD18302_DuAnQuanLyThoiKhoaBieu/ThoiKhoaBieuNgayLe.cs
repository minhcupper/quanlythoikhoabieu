...
namespace Mai_Văn_Minh_pd09444_SD18302_DuAnQuanLyThoiKhoaBieu
{
    public partial class ThoiKhoaBieu : Form
    {
        ...
        void load()
        {
            ...
            command.CommandText = "select *from Ca_GiaoVien where NgayDay='357' ";
            ...
            List<cahoc> ListCaHoc = new List<cahoc>()
    {
       ...
       new cahoc(){Slot=Slot[11].ToString(),Phong=Phong[11].ToString(),LopDay=MaLop[11].ToString(),TenGiangVien=GiaoVien[11].ToString(),MonDay=MonDay[11].ToString()},
        new cahoc(){Slot=Slot[12].ToString(),Phong=Phong[12].ToString(),LopDay=MaLop[12].ToString(),TenGiangVien=GiaoVien[12].ToString(),MonDay=MonDay[12].ToString()},
       new cahoc(){Slot=Slot[13].ToString(),Phong=Phong[13].ToString(),LopDay=MaLop[13].ToString(),TenGiangVien=GiaoVien[13].ToString(),MonDay=MonDay[13].ToString()},
       new cahoc(){Slot=Slot[14].ToString(),Phong=Phong[14].ToString(),LopDay=MaLop[14].ToString(),TenGiangVien=GiaoVien[14].ToString(),MonDay=MonDay[14].ToString()}
            };
            int i = 0;
